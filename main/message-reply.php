            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <div class="navbar-pic">
                    <a class="nav-item">
                        ...
                        <a href="index.html" style="text-decoration: none; color: black; padding-left: 10px;">Log Out</a>
                    </a>
                </div>
            </div>
        </nav>
            ...
            <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        if ($view_query->num_rows > 0) {
                            while ($row = $view_query->fetch_assoc()) {
                                ...
                                echo "<td class='nav-link-text ps-5'>" . $row['reciever'] . "</td>";
                ...
                <form action="add-message.php" method="post">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="md-4 mb-3 form-group">
                                        ...
                                        <select name="reciever" id="reciever" class="form-select form-select-md md-4 mb-3">
                    ...
                    <form action="add-message.php" method="post">
                        ...
                        echo $rowss['reciever'];
                        ?>">
                        <input type="hidden" name="reciever"value="<?php
                        echo $rowss['sender'];
                        ?>">
                        <div class="modal-dialog">
                            <div class="modal-content">
