...
if (count($_POST) > 0) {
    mysqli_query($conn, "UPDATE program SET name='" . $_POST['name'] . "', years='" . $_POST['years'] . "', degree='" . $_POST['degree'] . "', quota='" . $_POST['quota'] . "', language='" . $_POST['language'] . "' WHERE id='" . $id . "'");
                ...
                <div class="table-responsive">
                    <table class="table ">
                        ...
                        <tbody>
                            ...
                            $view = "SELECT id, name, years, degree, quota FROM program";
