...
<body style="background-color: rgb(240, 239, 239);">
    ...
    <div class="content">
        ...
        <div class="programs-div">
            <h2 class="db-title">Submitted Applications:</h2>
                    ...
                    <table class="table ">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-5">Nationality</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-5">Program</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-5">Year Graduated</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-5">Status</th>
                        ...
                        <tbody>
                            ...
                            if ($view_query->num_rows > 0) {
                                while ($row = $view_query->fetch_assoc()) {
                                    ...
                                    echo "<td class='nav-link-text ps-5'>" . $row['nationality'] . "</td>";
                                    echo "<td class='nav-link-text ps-5'>" . $row['program'] . "</td>";
                                    echo "<td class='nav-link-text ps-5'>" . $row['year_graduated'] . "</td>";
                                    echo "<td class='nav-link-text ps-5'>" . $row['status'] . "</td>";
                                    echo '<td class="nav-link-text ps-5">';
                                    echo '<div class="d-flex">';
                                    echo '<form action="application-delete.php" method="post" style="display:inline-block;">';
                                    ...
                                    //echo '</form>';
                                    echo '<a class="btn edit-btn" href="application-details.php?id=' . $row['id'] . '">Details</a>';
                                    echo '</td>';
                                    echo "</tr>";
                                }
                            } else {
                                echo "<tr>";
                                echo "<td class='nav-link-text ps-5' colspan='7' style='text-align: center;'>THERE ARE NO APPLICATIONS</td>";
                                echo "</tr>";
                            }
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="add-program.php" method="post">
